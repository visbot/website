...
<form data-netlify="true" name="lostpasswordform" id="lostpasswordform" action="/wp-login.php?action=lostpassword" method="post" class:shake={hasError} onsubmit={preventDefault(submitHandler)} bind:this={formElement} {hidden}>
