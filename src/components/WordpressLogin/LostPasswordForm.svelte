...
<svelte:head>
	{#if !hidden}
		<title
			>Lost Password &lsaquo; {import.meta.env.VITE_SITE_NAME
...
<p class="message" {hidden}>
	Please enter your username or email address. You will receive an email message with instructions on how to reset your
	password.
</p>
